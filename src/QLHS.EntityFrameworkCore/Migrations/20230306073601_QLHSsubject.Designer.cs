...
namespace QLHS.Migrations
{
    ...
    [Migration("20230306073601_QLHSsubject")]
    partial class QLHSsubject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QLHS.Rooms.Room", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("QLHS.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QLHS.Students.StudentRoom", b =>
                {
                    ...
                    b.ToTable("AppStudentRooms", (string)null);
                });

            modelBuilder.Entity("QLHS.Subjects.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QLHS.Teachers.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QLHS.Students.Student", b =>
                {
                    b.HasOne("QLHS.Teachers.Teacher", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QLHS.Students.StudentRoom", b =>
                {
                    b.HasOne("QLHS.Rooms.Room", null)
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QLHS.Students.Student", null)
                        .WithMany("Rooms")
